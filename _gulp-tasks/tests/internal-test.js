...
if(isInternal){
  ...
  describe('Internal Email', function(){
    ...
    describe('<webversion> tag', function() {
      ...
      it('should exist', function() {
        expect(webversion.is('webversion')).to.be.true;
      });

      if(webversion.is('webversion')){
        it('should not have more than two instances or less than one', function(){
          expect(webversion).to.have.length.of.at.least(1).and.at.most(2);
        });
      }
    ...
    describe('<unsubscribe> tag', function() {
      ...
      it('should exist', function(){
        expect(unsubscribe.is('unsubscribe')).to.be.true;
      });

      if(unsubscribe.is('unsubscribe')){
        it('should not have more or less than one instance', function(){
          expect(unsubscribe).to.have.length.of.at.least(1).and.at.most(1);
        });
      }
    ...
    describe('<singleline> tag', function() {
      ...
      it('should exist', function(){
        expect(singleline.is('singleline')).to.be.true;
      });

      if(singleline.is('singleline')){
        it('should not have more or less than one instance', function(){
          expect(singleline).to.have.length.of.at.least(1).and.at.most(1);
        });
      }
